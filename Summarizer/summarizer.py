...
def get_summary_from_text_file(file_path = "sample.txt"):
    ...
    stop_words = open("D:\Programming\Projects\major_project\Codes\Summarizer\stopwords.txt",'r',encoding="utf-8").read()
    word_endings = open("D:\Programming\Projects\major_project\Codes\Summarizer\word_endings.txt",'r',encoding='utf-8').read() 
...
if __name__ == "__main__":
    get_summary_from_text_file("D:\Programming\Projects\major_project\Codes\Summarizer\sample.txt")